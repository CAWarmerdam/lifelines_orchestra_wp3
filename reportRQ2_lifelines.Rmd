...
fun_med <- function(indepVar, medVar, indepName, medName, nMed = 1){
    ...
    neMod <- medflex::neModel(as.formula(paste("nbCovInfections ~ ", colnames(expData)[2], "+" ,colnames(expData)[3], "+ DEMOGRAPHICS_45 + DEMOGRAPHICS_46")), family = poisson, expData = expData, se = "robust", parallel = "multicore", ncpus = detectCores())
